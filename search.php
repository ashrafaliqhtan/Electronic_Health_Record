    ...
    <div class="container">
        ...
        <form action="" method="GET" class="form">
            <div class="form-group">
                <input type="text" name="query" placeholder="Search by name or contact" required>
        ...
        if (isset($_GET['query'])) {
            $query = $_GET['query'];
            $sql = "SELECT * FROM patients WHERE first_name LIKE '%$query%' OR last_name LIKE '%$query%' OR contact_number LIKE '%$query%'";
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
                echo "<table>";
                echo "<tr><th>ID</th><th>Name</th><th>Contact</th><th>Gender</th><th>Date of Birth</th></tr>";
