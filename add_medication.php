...
<body>
    ...
    <div class="container">
        ...
        <form action="" method="POST" class="form">
            ...
            <button type="submit" name="add_medication" class="button">Add Medication</button>
        </form>
        ...
        if (isset($_POST['add_medication'])) {
            ...
            $sql = "INSERT INTO medications (med_name, category, quantity, price) 
                    VALUES ('$med_name', '$category', '$quantity', '$price')";

            if ($conn->query($sql) === TRUE) {
                echo "<p class='success'>Medication added successfully.</p>";
            } else {
