...
<body>
    ...
    <div class="container">
        ...
        <?php
        $sql = "SELECT prescriptions.id, prescriptions.patient_id, patients.first_name, patients.last_name, prescriptions.medication, prescriptions.dosage 
                FROM prescriptions 
        ...
        if ($result->num_rows > 0) {
            echo "<table>";
            echo "<tr><th>Prescription ID</th><th>Patient Name</th><th>Medication</th><th>Dosage</th><th>Action</th></tr>";
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>{$row['dosage']}</td>
                        <td><button class='button'>Process</button></td>
                      </tr>";
            }
            echo "</table>";
        } else {
            echo "<p class='error'>No prescriptions found.</p>";
        }
        ?>
    </div>
